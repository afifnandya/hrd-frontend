    ...
    >
      ...
      <template #footer>
        ...
        <Button
          ...
          icon="pi pi-check"
          class="p-button-text"
          @click="editData(selectedDepartmen)"
        />
      </template>
    </Dialog>
    ...
    >
      ...
      <template #footer>
        ...
        <Button
          ...
          icon="pi pi-check"
          class="p-button-text"
          @click="deleteData(selectedDepartmen)"
        />
      </template>
    </Dialog>
  </div>
...
function editData(data: Department) {
  selectedDepartmen.id = data.id
  selectedDepartmen.nama = data.nama
  showModal.edit = true
}

function deleteData(data: Department) {
  selectedDepartmen.id = data.id
  selectedDepartmen.nama = data.nama
