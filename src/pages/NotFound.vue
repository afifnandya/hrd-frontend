<template>
  ...
  >
    <div class="grid justify-center p-2 lg:p-0" style="min-width: 80%">
      ...
      >
        <div
          class="flex justify-center h-full w-full m-0 py-7 px-4"
          style="
            border-radius: 53px;
            background: linear-gradient(
              180deg,
          ...
          "
        >
          <div class="grid flex-column items-center">
            <span class="text-blue-500 font-bold text-3xl">404</span>
            <h1 class="text-gray-900 font-bold text-3xl lg:text-5xl mb-2">
            ...
            >
            <div
              class="col-12 flex items-center py-5 mt-6 border-300 border-bottom-1"
            >
              <div
              ...
              <div class="ml-4">
                <router-link to="/">
                  <p class="text-gray-900 lg:text-xl font-medium mb-0">
            ...
            <div
              class="col-12 flex items-center py-5 border-300 border-bottom-1"
            >
              <div
